# TITLE real estate checker
# SOURCE https://www.webscrapingapi.com/real-estate-web-scraper/
# SOURCE https://www.webscrapingapi.com/python-web-scraping/
# SOURCE https://www.xbyte.io/how-to-use-python-to-scrape-real-estate-website-data-using-web-scraping-and-making-data-wrangling.php
# SOURCE https://blog.jovian.ai/how-to-purchase-property-using-web-scraping-1d7448ef6c2d
# SOURCE https://towardsdatascience.com/automating-real-estate-investment-analysis-d2b07395833b
# SOURCE git https://gist.github.com/Josh3005/c9e590c6cfced6e9077761f51d6a88a0
# https://www1.nyc.gov/site/finance/taxes/property-annualized-sales-update.page
# https://github.com/arunbsmrstu/Machine-Learning-Mastery-With-Python
...
def main():
	address_lookup(zipcode, parcel, house_number)
	school_ranking()
	crime_lookup()
	some_function()
	net_operating(rent, tax_rate, price)
	down_payment(price, percent)
	mortgage_monthly(price, years, percent)
	price_mine(url)
	cap_rate(monthly_income, price)
	cash_on_cash(monthly_income, down_payment)


def address_lookup(zipcode, parcel, house_number):
    """
    This will accept those parameters while doing a database search for some or all of your terms
    """

def school_ranking():
    """
    This will provide a list of schools, proximity to quality, quantity and rankings
    """

def crime_lookup():
    """
    This will provide a relative and objective crime score for the house location
    """
...
def mortgage_monthly(price, years, percent):
	"""
	This implements an approach to finding a monthly mortgage amount from the purchase price, years and percent.
	...
	:return: payment:
    """
	# TODO finish these variables once formula is finished
    percent = percent/100
